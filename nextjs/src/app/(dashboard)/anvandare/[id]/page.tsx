  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-zinc-500">
        <Link href="/anvandare" className="hover:text-gray-600 dark:hover:text-zinc-300 transition-colors">Användare</Link>
      ...
      {/* Tabs */}
      <UserTabs tabs={tabs} activeTab={tab} userId={id} />
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="panel-surface">
            <div className="px-6 py-4 border-b border-gray-100 dark:border-zinc-800">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Användarinformation</h2>
            </div>
      ...
      {/* Aktivitet */}
      {tab === 'aktivitet' && <ActivityLog userId={id} />}
    </div>
  )
}
...
async function ActivityLog({ userId }: { userId: string }) {
  ...
  return (
    <div className="panel-surface">
      <div className="px-6 py-4 border-b border-gray-100 dark:border-zinc-800">
        <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Aktivitetslogg</h2>
        <p className="text-xs text-gray-500 dark:text-zinc-400 mt-0.5">
          Senaste aktiviteter och systemhändelser
        </p>
      </div>
      {combined.length === 0 ? (
