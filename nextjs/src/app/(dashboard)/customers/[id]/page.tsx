                ...
                {customer.contacts.map((c) => (
                  <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <Link href={`/contacts/${c.id}`} className="font-medium text-gray-900 hover:text-zinc-600 transition-colors">
              ...
              <tbody className="divide-y divide-gray-100">
                {customer.quotes.map((q) => (
                  <tr key={q.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <Link href={`/quotes/${q.id}`} className="font-medium text-gray-900 hover:text-zinc-600 transition-colors">
                        {q.number}
                      </Link>
                    </td>
              ...
              <tbody className="divide-y divide-gray-100">
                {customer.invoices.map((inv) => (
                  <tr key={inv.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <Link href={`/invoices/${inv.id}`} className="font-medium text-gray-900 hover:text-zinc-600 transition-colors">
                        {inv.number}
                      </Link>
                    </td>
